...
REQUIRED = {
    ...
    "crates/runnel-cli/src/bin/runnel-m4-model-check.rs",
    "crates/runnel-cli/src/main.rs",
    "crates/runnel-cli/tests/cli.rs",
    "crates/runnel-cli/tests/m4_model_check.rs",
    ...
    "crates/runnel-kernels/src/bin/runnel-kernel-bench.rs",
    ...
    "crates/runnel-runtime/src/adapter.rs",
    "crates/runnel-runtime/src/attention.rs",
    "crates/runnel-runtime/src/error.rs",
    "crates/runnel-runtime/src/lib.rs",
    "crates/runnel-runtime/src/model.rs",
    "crates/runnel-runtime/src/model/transaction.rs",
    "crates/runnel-runtime/src/sampling.rs",
    "crates/runnel-runtime/src/state.rs",
    "crates/runnel-runtime/src/tensor.rs",
    "crates/runnel-runtime/src/tokenizer.rs",
    "crates/runnel-runtime/tests/oracle_parity.rs",
    "crates/runnel-scheduler/Cargo.toml",
    "crates/runnel-scheduler/src/accounting.rs",
    "crates/runnel-scheduler/src/actor.rs",
    "crates/runnel-scheduler/src/checkpoint.rs",
    "crates/runnel-scheduler/src/config.rs",
    "crates/runnel-scheduler/src/control.rs",
    "crates/runnel-scheduler/src/endpoint.rs",
    "crates/runnel-scheduler/src/engine.rs",
    "crates/runnel-scheduler/src/engine_adversarial_tests.rs",
    "crates/runnel-scheduler/src/error.rs",
    "crates/runnel-scheduler/src/id.rs",
    "crates/runnel-scheduler/src/ledger.rs",
    "crates/runnel-scheduler/src/ledger_trace.rs",
    "crates/runnel-scheduler/src/lib.rs",
    "crates/runnel-scheduler/src/request.rs",
    "crates/runnel-scheduler/src/ring.rs",
    "crates/runnel-scheduler/src/trace.rs",
    "crates/runnel-scheduler/src/wave.rs",
    "crates/runnel-scheduler/tests/actor_instrumented_public.rs",
    "crates/runnel-scheduler/tests/actor_public.rs",
    ...
    "crates/runnel-scheduler/tests/actor_script/race/capture.rs",
    "crates/runnel-scheduler/tests/actor_script/race/capture_file.rs",
    "crates/runnel-scheduler/tests/actor_script/race/cleanup.rs",
    "crates/runnel-scheduler/tests/actor_script/race/execution.rs",
    "crates/runnel-scheduler/tests/checkpoint_instrumented_public.rs",
    "crates/runnel-scheduler/tests/engine.rs",
    "crates/runnel-scheduler/tests/ledger_trace.rs",
    "crates/runnel-scheduler/tests/policy_replay.rs",
    ...
    "docs/adr/0007-transactional-paged-scheduling.md",
    ...
    "oracle/README.md",
    "oracle/__init__.py",
    "oracle/actor_race_history.py",
    "oracle/actor_race_verify.py",
    "oracle/actor_transcript.py",
    ...
    "oracle/tests/test_actor_race_history.py",
    "oracle/tests/test_actor_race_verify.py",
    "oracle/tests/test_actor_transcript.py",
    "oracle/tests/test_cache_policy.py",
    "oracle/tests/test_oracle.py",
    "oracle/tests/test_sampling.py",
    "oracle/tests/test_scheduler.py",
    "rust-toolchain.toml",
