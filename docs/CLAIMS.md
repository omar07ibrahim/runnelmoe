...
| Tiny adapter v2 keeps routed-expert weights in BF16 and preserves declared scalar/AVX2 numerical, route, and token parity | target | M4; frozen in [ADR-0006](adr/0006-bf16-avx2-expert-kernel.md), not yet implemented |
